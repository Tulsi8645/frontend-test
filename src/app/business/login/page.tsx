...
import { Bot, ArrowLeft, Building2, User, Lock, AlertCircle, Sparkles } from 'lucide-react';
                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-zinc-500">
                            ...
                            <Link href="/business/signup" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
                                Create one
                            </Link>
                        </p>
                    </div>
